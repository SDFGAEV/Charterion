...
const COMPANY_PRINCIPLES = [
  ...
  'Keep capability, authority, and protocol orthogonal: an Agent may be broadly capable while each concrete effect remains separately authorized and evidenced.',
  'Departments and Domains express durable ownership and review responsibility, not ceilings on Agent capability or permission to investigate.',
  'Give each Mission one accountable DRI with many contributors; route ordinary work to the owning Agent and reserve Supervisor capacity for review and integration.',
  ...
  'Prefer pull-based review by risk dimension; do not broadcast review prompts or recruit redundant reviewers once required coverage is satisfied.',
  'Share peer artifacts and evidence by reference; never copy mutable context into another Agent workspace or mutate another Agent worktree.',
...
const COMMON_PROCESS = [
  ...
  'Route ordinary work directly through ownership and the Mission DRI; involve a Supervisor for review/integration decisions, not every routine action.',
  'Send blockers, questions, review requests, and cross-domain needs through typed organization messages with explicit target and task context.',
